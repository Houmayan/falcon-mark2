        ...
        <div class="card_container">
            ...
            <div class="card">
                ...
                <div class="methods card" id="methods">
                    <!-- card payment -->
                    <form action="{{ route('checkout.credit-card') }}" enctype="multipart/form-data" method="post" class="card_payment" id="cardPayment">
                        @csrf
                        ...
                        <div class="input">
                            ...
                            <input type="text" name="billing_add" value="" id="bill_add" placeholder="Billing Address"
                    ...
                    <!-- bkash payment -->
                    <form action="{{ route('checkout.credit-card') }}" method="post" enctype="multipart/form-data" class="bkash_payment"
                        id="bkashPayment">
                        @csrf
                        ...
                        <div class="input">
                            ...
                            <input type="tel" name="b_number" value="" id="card_holder" placeholder="Bkash Account Number"
                                onKeyDown="if(this.value.length==11) return false;" pattern="01+[0-9]{9}"
                                inputMode="numeric" data-numeric required>
                        </div>
                        <div class="input">
                            <label for="card_holder">Transaction Id</label>
                            <input type="text" name="b_trans" value="" id="card_holder" placeholder="Bkash Transaction Id"
                                onKeyDown="if(this.value.length==10) return false;" pattern="(?=.*[0-9])(?=.*[A-Z]).{10}"
                                inputMode="numeric" data-numeric required>
                        </div>
                        <div class="input">
                            <label for="bill_add">Billing Address</label>
                            <input type="text" name="bill_add" id="bill_add" placeholder="Billing Address"
                                maxlength="100" required>
                        </div>
                        <br>
                        <hr>
                    ...
                    <form action="{{ route('checkout.credit-card') }}" method="post" enctype="multipart/form-data" class="cash_payment"
                        id="cashPayment">
                        @csrf
                        <input type="hidden" name="status" value="0">
                        <input type="hidden" name="method" value="card">
                        ...
                        <div class="input">
                            ...
                            <input type="tel" name="billing_phone" value="" id="card_holder" placeholder="Phone Number"
                                onKeyDown="if(this.value.length==11) return false;" pattern="01+[0-9]{9}"
                                inputMode="numeric" data-numeric required>
                        </div>
                        <div class="input">
